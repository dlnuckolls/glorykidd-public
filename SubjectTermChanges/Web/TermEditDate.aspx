<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermEditDate.aspx.cs" Inherits="Kindred.Knect.ITAT.Web.TermEditDate" %>
		...
		<asp:panel cssclass="TemplateEditBody AutoScroll" id="editBody" runat="server">
			...
			<table border="0" cellpadding="2" cellspacing="0" width="100%" style="table-layout:fixed;">
				...
				<tr>
					...
					<td  class="DataEntryCaption AlignLeft">Date</td>
				</tr>
				...
				<tr>
					...
					<td class="DataEntryCaption AlignLeft"><asp:checkbox id="chkRequired" runat="server" textalign="Right" cssclass="DataEntryCaption CheckBoxAlignLeft"   text=""  /></td>
				</tr>

                <tr id="trKeywordSearchable" runat="server" visible="true">
                    <td class="DataEntryCaption" style="height: 32px">Keyword Searchable:</td>
                    <td class="DataEntryCaption AlignLeft" style="height: 32px"><asp:checkbox id="chkbxKeywordSearchable" runat="server" textalign="Right" cssclass="DataEntryCaption CheckBoxAlignLeft" text=""  /></td>
                </tr>

				<tr>
					<td class="DataEntryCaption">Format:<br />&nbsp;</td>
					<td class="DataEntryCaption AlignLeft"><asp:dropdownlist id="ddlFormat" runat="server"  /><br />&nbsp;</td>
				</tr>
