...
namespace Kindred.Knect.ITAT.Web.Controls
{
    ...
    public class CheckBoxListValidator : BaseValidator
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.RenderUplevel && this.Page != null && !this.Page.ClientScript.IsClientScriptIncludeRegistered(this.GetType(), "khValidators"))
                this.Page.ClientScript.RegisterClientScriptInclude(this.GetType(), "khValidators", this.Page.ClientScript.GetWebResourceUrl(this.GetType(), "Kindred.Knect.ITAT.Web.Scripts.CheckboxValidator.js"));
        }
