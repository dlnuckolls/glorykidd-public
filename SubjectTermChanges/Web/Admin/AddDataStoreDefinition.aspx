<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDataStoreDefinition.aspx.cs"
    Inherits="Kindred.Knect.ITAT.Web.Admin.AddDataStoreDefinition" EnableViewStateMac="true" %>
...
<body id="htmlBody" runat="server">
    ...
    <asp:ValidationSummary ID="msgValidationSummar" runat="server" ShowMessageBox="true"
        DisplayMode="List" ShowSummary="false" ValidationGroup="RequiredValidation" />
    <kh:standardheader id="itatHeader" pagetitle="Add DataStore Definition" runat="server" />
    <div>
        <table id="tblDefinition" runat="server" width="100%" style="table-layout: fixed;
            border: 0 0 0 0;" cellpadding="1" cellspacing="0">
            <tr>
            ...
            <tr>
                <td class="ProfileCaption" width="114px">
                    <asp:RequiredFieldValidator ID="reqDefinitionName" runat="server" Text="*" Display="Dynamic"
                        ControlToValidate="txtDefinitionName" ValidationGroup="RequiredValidation" ErrorMessage="Enter Definition Name."></asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="cvdefinitionName" runat="server" Text="*" Display="Dynamic"
                        OnServerValidate="CheckValidFileName" ValidationGroup="RequiredValidation" ErrorMessage='Definition Name must not contain *|\/<>:"? or any special characters'></asp:CustomValidator>Definition
                    Name
                </td>
                <td class="DataEntryEdit" width="100%">
                    <asp:TextBox ID="txtDefinitionName" runat="server" Width="100%" EnableViewState="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="ProfileCaption" width="114px">
            ...
            <tr>
                <td class="ProfileCaption" width="114px">
                    <asp:RequiredFieldValidator ID="reqTemplate" runat="server" Text="*" Display="Dynamic"
                        ControlToValidate="lstSelectedTemplates" ValidationGroup="RequiredValidation"
                        ErrorMessage="Select atleast 1 Template."></asp:RequiredFieldValidator>
                    Template:
                </td>
                <td class="DataEntryEdit" width="100%">
                    <div style="width: 35%; float: left">
                        <asp:ListBox ID="lstTemplates" runat="server" SelectionMode="Multiple" Rows="6" Width="100%"
                            EnableViewState="true" />
                    </div>
                    <div style="width: 9%; float: left; vertical-align: middle; text-align: center;">
                        <br />
                        <asp:Button ID="btnAddTemplate" runat="server" Style="text-align: center" Text="&gt;&gt;"
                            OnClick="btnAddTemplate_Click" Width="30px"></asp:Button>
                        <br />
                        <br />
                        <asp:Button ID="btnRemoveTemplate" runat="server" Style="text-align: center" Text="&lt;&lt;"
                            OnClick="btnRemoveTemplate_Click" Width="30px"></asp:Button>
                    </div>
                    <div style="width: 55%">
            ...
            <tr>
                ...
                <td class="DataEntryEdit" width="99%">
                    ...
                    <asp:Button ID="btnAddTerm" runat="server" Style="text-align: center" Text="Add &gt;&gt;"
                        OnClick="btnAddTerm_Click" Width="100%" />
                </td>
            </tr>
            <tr>
                <td class="ProfileCaption" width="114px">
                    <asp:CustomValidator ID="reqSelectedTerms" runat="server" Text="*" Display="Dynamic"
                        OnServerValidate="CheckAtLeastOneTermIsSelected" ValidationGroup="RequiredValidation"
                        ErrorMessage="Select atleast 1 Term."></asp:CustomValidator>
                    Selected Terms
                </td>
                <td class="DataEntryEdit" width="99%">
                    <div style="border-style: none; border-color: inherit; border-width: 0; width: 95%;
                        ...
                        <table style="border-style: none; border-color: inherit; border-width: 0; width: 99%;">
                            <tr style="height: 5px;">
                                <td style="width: 60%; text-align: center" class="ProfileCaption">
                                    <div style="text-align: left; float: left; border: 0; margin: 0; height: 10px; width: 10px">
                                        <input id="checkAll" class="SelectAll" type="checkbox" style="border: 0; margin: 0;
                                            top: 0; height: 15px; width: 15px" /></div>
                                    Term
                                </td>
                        ...
                        <div class="listViewTable" style="width: 99%">
                            <asp:ListView ID="lvSelectedTerms" runat="server" SelectionMode="Multiple" EnableViewState="true"
                                OnItemDataBound="lvSelectedTerms_ItemDataBound">
                                <LayoutTemplate>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr id="itemPlaceholder" runat="server" style="width: 100%" class="listview">
                                        </tr>
                                    </table>
                                </LayoutTemplate>
                                <ItemTemplate>
                                    <tr style="width: 98%">
                                        <td style="width: 59%">
                                            <asp:CheckBox runat="server" class="checkedbox" myattr="checkedbox" ID="chkTerm"
                                                Text='<%#Eval("Name") %>' Checked='<%#Eval("IsChecked")%>' Width="100%" Style="display: block">
                                            </asp:CheckBox>
                                        </td>
                                        ...
                                        <td style="width: 14%; text-align: left">
                                            <asp:TextBox runat="server" ID="txtAlias" class="aliasbox" Width="140px" MaxLength="90"></asp:TextBox>
                                        </td>
                                        <td style="width: 6%; text-align: left">
                                            <asp:TextBox runat="server" Class="size" ID="txtSize" Width="40px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                    ...
                    <br />
                    <br />
                    <asp:Button ID="btnRemoveTerm" runat="server" Style="text-align: center" Text="&lt;&lt; Remove"
                        OnClick="btnRemoveTerm_Click" Width="100%"></asp:Button>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="left" valign="top" style="border: 0 0 0 0; padding: 0 0 0 0">
                    <itat:itatplaceholder id="apnlCriteria" runat="server" width="100%" style="padding: 0 0 0 0;
                        left: 0; border: 0 0 0 0;"></itat:itatplaceholder>
                </td>
            </tr>
            <tr>
                <td class="ProfileCaption" width="114px">
                    <asp:CustomValidator ID="reqStatus" runat="server" Text="" Display="Dynamic" OnServerValidate="CheckAtLeastOneStatus"
                        ValidationGroup="RequiredValidation1" ErrorMessage="Select atleast 1 Status."></asp:CustomValidator>
                    Status
                </td>
                <td class="DataEntryEdit" width="100%">
            ...
            <tr>
                ...
                <td class="DataEntryEdit" width="100%">
                    ...
                    <asp:RadioButton ID="radTypeDelta" Checked="false" runat="server" GroupName="loadType"
                        Text="Delta Load" />
                    <asp:TextBox ID="txtDeltaDays" runat="server" Width="114px" MaxLength="12" Visible="true" />
                    days.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="ProfileCaption" width="114px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtPath"
                        runat="server" ErrorMessage="Enter Path to export CSV file." Text="*" ValidationGroup="RequiredValidation"></asp:RequiredFieldValidator>
                    Path
                </td>
                <td class="DataEntryEdit" width="100%">
            ...
            <tr>
                ...
                <td class="DataEntryEdit" width="100%">
                    <asp:RadioButton ID="radActiveYes" Checked="true" Text="Yes" runat="server" GroupName="radActive" />
                    <asp:RadioButton ID="radActiveNo" Checked="false" Text="No" runat="server" GroupName="radActive" />
                </td>
            </tr>
            <tr>
                <td class="ProfileCaption" width="114px">
                    <asp:RequiredFieldValidator ID="reqEmailValidator" ControlToValidate="txtEmail" runat="server"
                        ErrorMessage="Enter atleast one email address for Error Log Recepient" Text="*"
                        ValidationGroup="RequiredValidation"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="AlignRight" style="padding: 0 0 0 0; height: 34px;">
                    <asp:Button ID="btnPromote" runat="server" Text="Save" CssClass="KnectButton" OnClick="btnPromote_Click" />
