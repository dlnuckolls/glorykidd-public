<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RetroNotification.aspx.cs" Inherits="Kindred.Knect.ITAT.Web.RetroNotification" %>
...
<body id="htmlBody" class="NoScroll" runat="server">
	...
	<kh:standardheader id="header" runat="server"  pagetitle="Edit Retro Notification"  />
			...
			<table cellpadding="2" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="DataEntryCaption AlignLeft">
						...
						<button id="btnClearEditors" runat="server" class="KnectButton" onclick="_kh_deselectListItems(this);">Clear</button>
					</td>
				</tr>
