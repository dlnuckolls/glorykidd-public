<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MyUploads.aspx.cs" Inherits="SDTPortal.MyUploads" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContentArea" runat="server">
  ...
  <asp:Panel ID="UploadFilesView" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetSystemRecipients" TypeName="SDTPortal.SqlDatasets"></asp:ObjectDataSource>
  </asp:Panel>
